  ...
  <div class="container">
	<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
  	...
  	<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
    	...
    	<li><a href="{{ route('usuarios.index') }}" class="nav-link px-2 text-white">Usuarios</a></li>
    	<li><a href="{{ route('professores.index') }}" class="nav-link px-2 text-white">Professores</a></li>
    	<li><a href="{{ route('disciplinas.index') }}" class="nav-link px-2 text-white">Disciplinas</a></li>
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" style="background-color: #F2D5E5">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('materiais.index') }}">Literatura <svg
                                                xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-disabled="true" href="{{ route('duvidas.index') }}">Dúvidas <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('configuracao.index') }}">Configurações <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
							...
							@auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('perfil.index') }}">{{auth()->user()->nickname}} <svg xmlns="http://www.w3.org/2000/svg"
