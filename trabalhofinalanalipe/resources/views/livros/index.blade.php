...
<div class="bg-light p-5 rounded">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <button class="card" style="width: 18rem;" data-bs-toggle="modal" data-bs-target="#ModalPostagens">
                ...
                <div class="card-body">
                    ...
                    @if($livro->tipo == "verao")
                    <span class="badge text-bg-danger">Verão <svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <span class="badge text-bg-info">Inverno <svg xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" class="bi bi-snow" viewBox="0 0 16 16">
                            <path
                    ...
                    <span class="badge text-bg-warning">Outono <svg xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" class="bi bi-peace" viewBox="0 0 16 16">
                            <path
                    ...
                    <span class="badge text-bg-success">Primavera <svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    @if(auth()->user()->role == "admin" || auth()->user()->role == "professor" || auth()->user()->role
                    == "bolsista1" || auth()->user()->role == "bolsista2")
                    <button type="button" class="btn badge text-bg-danger" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">Excluir <svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <div class="modal fade" id="ModalPostagens" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {!! Form::open(['method' => 'DELETE','route' => ['livros.destroy',
                                    $livro->id],'style'=>'display:inline']) !!}
