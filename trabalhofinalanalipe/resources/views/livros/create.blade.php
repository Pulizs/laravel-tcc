...
<div class="bg-light p-5 rounded">
    ...
    <center>
        ...
        <div class="card" style="width: 50%;">
            <div class="card-body">
                <p class="card-text">Criando Livro <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Autor" aria-label="Autor"
                            name="autor" aria-describedby="basic-addon1">
                    </div>
                    <select class="form-select" aria-label="estação do ano" name="tipo">
                        <option selected>Estação do ano</option>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" placeholder="Ano de Publicação" aria-label="Ano de Publicação"
                            name="publicacao" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                                name="resenha" style="height: 100px"></textarea>
                            <label for="floatingTextarea2">Escreva a resenha do livro...</label>
                        </div>
                    </div>
